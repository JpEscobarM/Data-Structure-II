...
void salvarEmArquivoBinario(ListaPessoa *l)
{
    ...
    if(!arquivo)
    {
     ...
     fwrite(l->pessoas,sizeof(Pessoa),l->qtdPessoa,arquivo);
...
int main() {
    ...
    printf("5 - Escrever em arquivo binario\n",tam);
    printf("6 - Ler em arquivo binario\n",tam);
    printf("0 - Sair\n");
    printf("Escolha: ");
    scanf("%d", &op);
    scanf("%*c");
